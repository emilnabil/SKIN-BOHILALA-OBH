#!/bin/sh # 
 # # Command: wget https://raw.githubusercontent.com/emilnabil/SKIN-BOHILALA-OBH/main/installer.sh -qO - | /bin/sh # # ########################################### ###########################################  
MY_URL="https://raw.githubusercontent.com/emilnabil/SKIN-BOHILALA-OBH/main"
